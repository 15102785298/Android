...
import wust.tantian.adapter.TelExpandableListAdapter;
...
public class FoodFragment extends Fragment{
	...
	private void loadData() {
        //从xml中取出数据来填充
        String[] telGroupNameArr = getResources().getStringArray(R.array.string_food);

        ArrayList<String[]> arr = new ArrayList<String[]>() ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr000)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr111)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr222)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr333)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr444)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr555)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr666)) ;    
