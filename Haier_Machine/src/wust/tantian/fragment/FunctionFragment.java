...
public class FunctionFragment extends Fragment{
	...
	private void loadData() {
        //从xml中取出数据来填充
        String[] telGroupNameArr = getResources().getStringArray(R.array.string_function);

        ArrayList<String[]> arr = new ArrayList<String[]>() ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr0)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr1)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr2)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr3)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr4)) ;
        arr.add(getResources().getStringArray(R.array.telGroupItemArr5)) ;
